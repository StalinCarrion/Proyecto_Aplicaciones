...
| Flujo básico:  |
| | 1. El sistema mostrará un mapa en donde se muestre la posición del conductor y el parqueadero al que desea ir.	`n`2. El sistema calculará la distancia entre el conductor y el parqueadero. `n` 3. El sistema le mostrará al conductor en forma de mensaje el tiempo en minutos que tardará en llegar a ese parqueadero. |
